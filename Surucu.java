...
//        System.out.println(cizelge.dependencyMap);
		...
		while (cizelge.stillContinues()) { // stillContinues metodu ile job dosyasında bir şey bulunup bulunmadığına
											// bakılır
			...
			cizelge.dependencyBlockedJobs(); // prints jobs whose time is up but waits due to its dependency, also
												// prints its dependency
